...
# nohup python train_lnc_nlm_dino_ali_wavlm.py --save_dir wavlm_dino_ali_lnc_nlm_8k_loadpre --gpu 0,1 --port 8441 > wavlm_dino_ali_lnc_nlm_8k_loadpre.log & 
...
parser.add_argument('--laebl_update_epochs', default=70, type=int)
...
parser.add_argument('--freeze_ptm', default=True, type=str2bool)
...
def main_worker(gpu, args):
    ...
    ckp = torch.load('exp/dino_ali_lnc_nlm_8k_wavlm_layer24_step1/model_step1_29.pkl', map_location='cpu')['model']
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        loss, prec, new_labels, teacher_loss = train(trn_loader, model_ptm, model, ema_teacher, criterion, optimizer, scheduler, epoch, is_update, args)
...
def train(trn_loader, model_ptm, model, ema_teacher, criterion, optimizer, scheduler, epoch, is_update, args):
